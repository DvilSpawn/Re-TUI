...
object RetuiThemeBridge {
    ...
    private fun buildLauncherThemeBundle(
        ...
        val bundle = Bundle()
        val terminalSurfaceColor = ThemeColorResolver.color(Theme.workspace_panel_background_color)
        val terminalHeaderColor = ThemeColorResolver.color(Theme.workspace_header_background_color)
        val terminalBorderColor = ThemeColorResolver.color(Theme.workspace_panel_border_color)
        val outputSurfaceColor = ThemeColorResolver.color(Theme.workspace_output_background_color)
        val inputSurfaceColor = ThemeColorResolver.color(Theme.workspace_input_background_color)
        ...
        val panelText = ThemeColorResolver.color(Theme.module_panel_text_color)
        val buttonBg = ThemeColorResolver.color(Theme.button_background_color)
        ...
        bundle.putInt(RetuiVisualContract.BUTTON_TEXT, ThemeColorResolver.color(Theme.button_text_color))
        bundle.putInt(RetuiVisualContract.BUTTON_BORDER, ThemeColorResolver.color(Theme.button_border_color))
        ...
        bundle.putInt(RetuiVisualContract.SELECTION_TEXT, ThemeColorResolver.color(Theme.selection_text_color))
